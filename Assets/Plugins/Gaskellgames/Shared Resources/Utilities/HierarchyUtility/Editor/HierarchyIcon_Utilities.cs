...
namespace Gaskellgames
{
    ...
    public class HierarchyIcon_Utilities
    {
        ...
        {
            icon_Comment = AssetDatabase.LoadAssetAtPath("Assets/Plugins/Gaskellgames/Shared Resources/Utilities/HierarchyUtility/Editor/Icons/Icon_Comment.png", typeof(Texture2D)) as Texture2D;
